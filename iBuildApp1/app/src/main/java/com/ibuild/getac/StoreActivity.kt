...
class StoreActivity : AppCompatActivity() {
    ...
    private fun products(): List<Product> {
        return listOf(
            ...
            Product("Nome do produto 6", 2.30, "metro", "Dicico", 4.8),
            Product("Nome do produto 7", 2.30, "metro", "Dicico", 4.8),
            Product("Nome do produto 8", 2.30, "metro", "Dicico", 4.8),
            Product("Nome do produto 9", 2.30, "metro", "Dicico", 4.8),
            Product("Nome do produto 10", 2.30, "metro", "Dicico", 4.8),
            Product("Nome do produto 11", 2.30, "metro", "Dicico", 4.8),
            Product("Nome do produto 12", 2.30, "metro", "Dicico", 4.8),
            Product("Nome do produto 13", 2.30, "metro", "Dicico", 4.8)
        )
    }
}
